...
When would a user ever want results for multiple languages anyway? They're expected to be using the WordPicker with a specific word in mind, not browsing generically. So this makes mych more semse frpm a UX pov
