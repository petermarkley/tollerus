# Spanish Grammar Preset

## Word class structure:
* (group) - **inflected** by gender, number
  * `adjective`
  * `numeral adjective`
* (group)
  * `adverb`
* (group) - **inflected** by role, tense, aspect, mood, gender, formality, number, person
  * `auxiliary verb`
  * `verb`
* (group) - **inflected** by gender, number
  * `article`
...
* (group)
  * `preposition`
* (group) - **inflected** by person, number, gender, case
  * `pronoun`
  * `numeral pronoun`
...
* case
  ...
  * reflexive (self-object)
  * prepositional

# Spanish Adjective Inflections

(The neuter gender does not produce new inflected forms here.)

|  | masculine | feminine |
|--|--|--|
| singular | rápido | rápida |
| plural | rápidos | rápidas |

# Spanish Article Inflections

Here **the neuter gender does produce a new form.**
...
## Listed forms
|  | role | number | person | tense | aspect | mood | gender | formality |
|--|--|--|--|--|--|--|--|--|
| hablar | infinitive | | | | | | | |
| hablo | finite | singular | first-person | present | simple | indicative | | |
| hablas | finite | singular | second-person | present | simple | indicative | | |
...
| hables | finite | singular | second-person | present | simple | subjunctive | | |
...
| habla | finite | singular | second-person | | | imperative | | familiar |
...
> [!Note]
> 
> If we were to be **theoretically pure** in the sense that no two grammar categories that are 100% identical in morphology are represented, we would go through and merged them, erasing non-identifying inflection values when appropriate.
> 
> However, there's a cost: the tables would then feel tangibly incomplete. The inflection patterns of Spanish are so strong and would be so close to complete, that when a hole appears it's felt. The reader might wonder what form of *hablar* is used for a certain grammatical category, since it wouldn't be listed.
> 
> Technically the author of the dictionary could enter one form and re-use it in multiple rows in the inflection tables, but this is discouraged in the Tollerus UI (and an unsupported outcome of some data filling features). I think instead, it's actually worth some minimal conceded duplication with the following explicit list of forms:
> * "hablamos" (first person plural, present vs. preterite)
> * "hablaba" (1st vs. 3rd person singular imperfect indicative)
> * "hablaría" (1st vs. 3rd person singular conditional)
> * "hable" (1st vs. 3rd person singular present subjunctive)
> * "hablara" (1st vs. 3rd person singular imperfect subjunctive)
> * "hablare" (1st vs. 3rd person singular future subjunctive)
> * the 3 repurposed imperative forms "habla"/"hable"/"hablen"
...
|  | first-person | second-person | third-person masculine | third-person feminine |
|--|--|--|--|--|
| singular nominative  (subject)      | yo | tú | él | ella |
| singular accusative (direct object) | me | te | lo | la |
| singular dative (indirect object)   | me | te | le | le |
| singular reflexive (self-object)    | me | te | se | se |
| singular prepositional              | mí | ti | él | ella |

|  | first-person masculine | first-person feminine | second-person masculine | second-person feminine | third-person masculine | third-person feminine |
|--|--|--|--|--|--|--|
| plural nominative (subject)       | nosotros | nosotras | vosotros | vosotras | ellos | ellas |
| plural accusative (direct object) | nos | nos | os | os | los | las |
| plural dative (indirect object)   | nos | nos | os | os | les | les |
| plural reflexive (self-object)    | nos | nos | os | os | se | se |
