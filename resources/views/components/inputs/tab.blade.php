...
<li
    ...
    tabindex="0"
    x-bind:class="{
        'relative rounded-t-lg flex flex-row justify-start items-center gap-2 cursor-pointer py-2 px-4 focus:outline-2 outline-offset-2 outline-blue-700 dark:outline-white': true,
