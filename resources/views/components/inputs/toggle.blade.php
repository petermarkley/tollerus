...
<div class="flex flex-col gap-1 items-start">
    <div class="flex flex-row gap-4 justify-start items-center">
        ...
        <div class="relative inline-block w-[56px] h-[32px] group">
            <input type="checkbox" id="{{ $id }}" class="absolute opacity-0 inset-0 w-full h-full cursor-pointer z-10" wire:model="{{ $model }}" @checked($checked) wire:change="$set('dirty', true)">
