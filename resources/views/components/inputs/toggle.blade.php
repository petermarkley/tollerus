...
<div class="flex flex-col gap-1 items-start">
    <div class="flex flex-row gap-4 justify-start items-center">
        ...
        <div class="relative inline-block w-[56px] h-[32px] group">
            ...
            <span class="absolute rounded-full cursor-pointer inset-shadow-sm bg-zinc-500 group-has-checked:bg-cyan-800 group-has-checked:dark:bg-cyan-500 group-has-checked:dark:saturate-50 transition duration-200 inset-0 w-full h-full group-has-focus:outline-2 outline-offset-2 outline-blue-700 dark:outline-white">
