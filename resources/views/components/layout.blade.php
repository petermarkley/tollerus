...
<html class="bg-gradient-to-b from-zinc-300 to-zinc-300 text-zinc-900 bg-repeat-x dark:from-zinc-800 dark:to-zinc-900 dark:text-zinc-300 w-full h-full">
    ...
    <body>
        <div class="w-full h-full absolute -z-10 bg-gradient-to-b from-zinc-300 to-zinc-400 bg-repeat-x mask-[url(/vendor/tollerus/bg.svg)] mask-size-[400px] mask-alpha mask-repeat dark:from-zinc-800 dark:to-zinc-800 opacity-50 dark:opacity-100" role="none" aria-hidden="true"></div>
