...
@endphp
@if ($href)
    <a {{ $attributes->merge(['class' => $pStyle.'block relative group text-zinc-900 dark:text-zinc-300 rounded-lg inset-shadow-sm bg-zinc-50 dark:bg-zinc-900/30 cursor-pointer hover:opacity-70']) }}>
        {{ $slot }}
